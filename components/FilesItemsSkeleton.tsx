export default function FilesItemsSkeleton() {
  // Show 8 skeleton rows: first 3 as "folders", rest as "files"
  const rows = [
    { isFolder: true, nameWidth: 'w-36', metaWidth: 'w-20' },
    { isFolder: true, nameWidth: 'w-48', metaWidth: 'w-24' },
    { isFolder: true, nameWidth: 'w-32', metaWidth: 'w-16' },
    { isFolder: false, nameWidth: 'w-44', metaWidth: 'w-28' },
    { isFolder: false, nameWidth: 'w-56', metaWidth: 'w-20' },
    { isFolder: false, nameWidth: 'w-40', metaWidth: 'w-24' },
    { isFolder: false, nameWidth: 'w-36', metaWidth: 'w-16' },
    { isFolder: false, nameWidth: 'w-52', metaWidth: 'w-20' },
  ];

  return (
    <div className="space-y-3">
      {/* Toolbar skeleton (search + select button) */}
