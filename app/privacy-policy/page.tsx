      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 ml-4">
              <li>
                <strong>Dengan persetujuan Anda:</strong> Ketika Anda membagikan file dengan pengguna lain
              </li>
              <li>
                <strong>Untuk kepatuhan hukum:</strong> Jika diwajibkan oleh hukum atau proses hukum
              </li>
              <li>
                <strong>Untuk keamanan:</strong> Untuk melindungi hak, properti, atau keselamatan
              </li>
              <li>
                <strong>Penyedia layanan:</strong> Dengan vendor pihak ketiga yang membantu operasi kami
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 ml-4">
              <li>
                <strong>Akses:</strong> Melihat informasi pribadi yang kami miliki tentang Anda
              </li>
              <li>
              ...
              <li>
                <strong>Portabilitas:</strong> Mengunduh data Anda dalam format yang dapat dibaca
              </li>
              <li>
                <strong>Pembatasan:</strong> Membatasi pemrosesan data Anda
              </li>
              <li>
                <strong>Keberatan:</strong> Menolak penggunaan data tertentu
              </li>
            </ul>
          </section>
            ...
            <div className="bg-[#003a69]/5 dark:bg-[#ebbd18]/5 rounded-lg p-4 space-y-2">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                <a
                  ...
                  className="text-[#003a69] dark:text-[#ebbd18] hover:underline"
                >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Website:{' '}
                <a
                  href="https://diskominfo.oganilirkab.go.id"
                  className="text-[#003a69] dark:text-[#ebbd18] hover:underline"
                >
